...
export class CreateReservaDto {
  ...
  @Min(1, {
    message:
      'El ID del vuelo debe ser mayor o igual a 1',
  })
  ...
  @IsInt({
    message:
      'El ID del pasajero debe ser un número entero',
  })
  @Min(1, {
    message:
      'El ID del pasajero debe ser mayor o igual a 1',
  })
  ...
  @Min(0, {
    message:
      'El total de la reserva no puede ser negativo',
  })
  totalReserva: number;
