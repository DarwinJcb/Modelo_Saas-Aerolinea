...
import { IsDate, IsEnum, IsInt, IsNumber, IsOptional, IsString, Length, Matches, MaxLength, Min, } from 'class-validator';
...
export class CreateVueloDto {
  ...
  @Type(() => Number)
  @IsInt({
    message: 'El ID de la ruta debe ser un número entero',
  })
  @Min(1, {
  ...
  @Type(() => Number)
  @IsInt({
    message: 'El ID del avión debe ser un número entero',
  })
  @Min(1, {
    message:
      'El ID del avión debe ser mayor o igual a 1',
  })
  fkAvionVuelo: number;
  ...
  @Length(2, 20, {
    message:
      'El número de vuelo debe contener entre 2 y 20 caracteres',
  })
  @Matches(/^[A-Z0-9-]+$/, {
    message:
      'El número de vuelo solo puede contener letras, números y guiones',
  })
  @Transform(({ value }) =>
    typeof value === 'string'
  ...
  @IsDate({
    message:
      'La fecha y hora de llegada no es válida',
  })
  ...
  @MaxLength(20, {
    message:
      'La puerta de embarque no puede superar los 20 caracteres',
  })
  @Transform(({ value }) =>
    typeof value === 'string'
      ? value.trim().toUpperCase()
  ...
  @IsNumber(
    ...
    {
      message:
        'El precio base debe ser un número con máximo 2 decimales',
    },
  )
  @Min(0, {
