...
export class CreateRutaDto {
  ...
  @IsInt({
    message:
      'El ID del aeropuerto de origen debe ser un número entero',
  })
  @Min(1, {
    message:
      'El ID del aeropuerto de origen debe ser mayor o igual a 1',
  })
  ...
  @IsInt({
    message:
      'El ID del aeropuerto de destino debe ser un número entero',
  })
  @Min(1, {
    message:
      'El ID del aeropuerto de destino debe ser mayor o igual a 1',
  })
  ...
  @Length(3, 20, {
    message:
      'El código de la ruta debe contener entre 3 y 20 caracteres',
  })
  @Matches(/^[A-Z0-9-]+$/, {
    message:
  ...
  @Min(1, {
    message:
      'La duración estimada debe ser mayor o igual a 1 minuto',
  })
  @Max(3000, {
    message:
      'La duración estimada no puede superar 3000 minutos',
  })
  ...
  @IsNumber(
    ...
    {
      message:
        'La distancia debe ser un número con máximo 2 decimales',
    },
  )
  @Min(0.01, {
  ...
  @Max(50000, {
    message:
      'La distancia no puede superar 50000 kilómetros',
  })
